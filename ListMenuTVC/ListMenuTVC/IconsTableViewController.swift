...
class IconsTableViewController: UITableViewController {
    ...
    var IconList: [Icon] = IconSet.getIcons()
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("IconIdentifier", forIndexPath: indexPath) as UITableViewCell
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "ShowDetails" {
            let nav = segue.destinationViewController as! DetaildedViewController
            if let indexPath = tableView.indexPathForSelectedRow{
                let icon = IconList[indexPath.row]
                nav.textName = icon.title
                nav.title = icon.name
            }
        }
